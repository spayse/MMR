...
//        //end
        ...
        assert(hashGenesisBlock == uint256("0x00000e84324f48dd86136d46987e64eeaac063f66a2f7112b00114a5bee7f07b"));
        assert(genesis.hashMerkleRoot == uint256("0xcebae040716b19e75276c0071d184ccd8156fb33b6db85868801aaa0e68077d09"));
...
public:
    CTestNetParams() {
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00006b6a783a64149b3737a0d98969026b755327fa0f21d135a15339b930fdbc"));
...
public:
    CRegTestParams() {
        ...
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x4a3b48caa94ed256ac907c95612bbf08a8a6efe6e13c5c676930049696d6ef74"));
