...
clean: release-clean debug-clean  FORCE
	-$(DEL_FILE) /mnt/MMR/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) /mnt/MMR/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) clean
distclean: release-distclean debug-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) /mnt/MMR/mmr-qt_plugin_import.cpp .qmake.stash

/mnt/MMR/src/leveldb/libleveldb.a: FORCE
	cd /mnt/MMR/src/leveldb && CC=i686-w64-mingw32.static-gcc CXX=i686-w64-mingw32.static-g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -O2" libleveldb.a libmemenv.a && i686-w64-mingw32.static-ranlib /mnt/MMR/src/leveldb/libleveldb.a && i686-w64-mingw32.static-ranlib /mnt/MMR/src/leveldb/libmemenv.a
